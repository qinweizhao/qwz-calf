...
<script>
import { listData, getData, delData, addData, updateData, exportData } from "@/api/system/manage/dict/data";
import { listAllSimple, getType } from "@/api/system/manage/dict/type";
