...
import com.qinweizhao.common.event.LogEvent;
import com.qinweizhao.common.util.*;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.qinweizhao.common.annotation.Log)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        commonLog.setIp(ip)
                ...
                .setTraceId(request.getHeader(Constants.MATE_TRACE_ID))
